...
const founders = [
  {
    ...
    description:
      "Visionary leader passionate about building inclusive communities and creating unforgettable experiences for our members.",
    image: "/kuzma.png",
  },
  {
    name: "Hamza",
    role: "Founder of Hiverse",
    description:
      "Community architect dedicated to fostering connections and delivering value through innovative events and partnerships.",
    image: "/hamza.png",
  },
];
              ...
              <CardContent className="p-8 text-center space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p
                    ...
                    data-testid={`text-founder-role-${index}`}
                  >
                    {founder.role}
                  </p>
                </div>
                ...
                <p
                  ...
                  data-testid={`text-founder-description-${index}`}
                >
                  {founder.description}
                </p>
              </CardContent>
